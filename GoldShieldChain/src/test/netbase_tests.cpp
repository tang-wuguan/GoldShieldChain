...
{
    BOOST_CHECK(TestSplitHost("www.goldshieldchain.org", "www.goldshieldchain.org", -1));
    BOOST_CHECK(TestSplitHost("[www.goldshieldchain.org]", "www.goldshieldchain.org", -1));
    BOOST_CHECK(TestSplitHost("www.goldshieldchain.org:80", "www.goldshieldchain.org", 80));
    BOOST_CHECK(TestSplitHost("[www.goldshieldchain.org]:80", "www.goldshieldchain.org", 80));

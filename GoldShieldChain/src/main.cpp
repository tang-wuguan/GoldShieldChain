...
#if defined(NDEBUG)
# error "GoldShieldChain cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "GoldShieldChain Signed Message:\n";
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, unsigned int flags)
{
    ...
    // fMiner is true when called from the internal GoldShieldChain miner
...
{
    RenameThread("GoldShieldChain-loadblk");

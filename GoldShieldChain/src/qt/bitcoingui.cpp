...
{
    resize(970, 550); 
    setWindowTitle(tr("GoldShieldChain") + " - " + tr("Wallet"));
qApp->setStyleSheet("QMainWindow { background-image: url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top: 0px;padding-bottom: 0px;spacing: 10px;color:rgb(255,255,255);} QToolBar QLabel:item { padding-top: 0px;padding-bottom: 0px;spacing: 10px;color:rgb(255,255,255);} #spacer { background:rgb(116,114,215);border:none; } #toolbar2 { border:none;width:0px;hight:0px;padding-top:0px;padding-bottom:0px; background: rgb(80,77,215); } #toolbar { border:1px; height:100%;padding-top:20px; background: rgb(116,114,215); text-align: left; color:rgb(255,255,255);min-width:150px;max-width:150px;} QToolBar QToolButton:hover {background-color:qlineargradient(x1: 0, y1: 0, x2: 2, y2: 2,stop: 0 rgb(116,114,215), stop: 1 rgb(80,77,215),stop: 2 rgb(80,77,215));}"
#ifdef Q_OS_MAC
"QToolBar QToolButton { font-family:sans-serif;font-size:13px;padding-left:20px;padding-right:45px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(255,255,255); text-align: left; background-color: rgb(116,114,215);  }"
#else
"QToolBar QToolButton { font-family:sans-serif;font-size:13px;padding-left:20px;padding-right:150px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(255,255,255); text-align: left; background-color: rgb(116,114,215);  }"
#endif
"#labelMiningIcon { padding-left:5px;font-family:sans-serif;width:100%;font-size:10px;text-align:center;color:rgb(255,255,255); } QMenu { background: rgb(116,114,215); color:rgb(255,255,255); padding-bottom:10px; } QMenu::item { color:rgb(255,255,255); background-color: transparent; } QMenu::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(116,114,215), stop: 1 rgb(80,77,215)); } QMenuBar { background: rgb(116,114,215); color:rgb(255,255,255); } QMenuBar::item { font-size:12px;padding-bottom:6px;padding-top:6px;padding-left:15px;padding-right:15px;color:rgb(255,255,255); background-color: transparent; } QMenuBar::item:selected { background-color:qlineargradient(x1: 0, y1: 0, x2: 0.5, y2: 0.5,stop: 0 rgb(80,77,215), stop: 1 rgb(116,114,215)); }");
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GoldShieldChain address"));
...
/*    connect(exchangeAction, SIGNAL(triggered()), this, SLOT(gotoExchangePage()));*/
    ...
    aboutAction = new QAction(tr("&About GoldShieldChain"), this);
    aboutAction->setToolTip(tr("Show information about GoldShieldChain"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for GoldShieldChain"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GoldShieldChain client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("GoldShieldChain client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GoldShieldChain network", "", count));
}
...
{
    QString strTitle = tr("GoldShieldChain") + " - ";
    ...
    case CClientUIInterface::MSG_WARNING:
        strTitle += tr("Warning");
        break;
    case CClientUIInterface::MSG_GSCORMATION:
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GoldShieldChain address or malformed URI parameters."));
    }
